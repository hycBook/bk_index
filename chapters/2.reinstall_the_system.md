...
1. 百度搜索[微软官网工具](https://www.microsoft.com/zh-cn/software-download/windows10/)
   ...
   <center><img src="./res/2. reinstall_the_system/image-20210121171520084.png" width=600></img></center>
...
1. 百度搜索[itellyou](https://msdn.itellyou.cn/)，下载系统镜像
   ...
   <center><img src="./res/2. reinstall_the_system/image-20210121172227945.png" width=700></img></center>

2. 下载u盘启动盘制作工具[UltraISO](https://cn.ultraiso.net/xiazai.html)，安装后执行

   <center><img src="./res/2. reinstall_the_system/image-20210121172408486.png" width=600></img></center>

   <center><img src="./res/2. reinstall_the_system/image-20210121172424293.png" width=400></img></center>
...
* 找到`Internet信息服务`，并选中`FTP服务`、`FTP扩展性`和`IIS管理控制台`前的复选框，点击确定
  ...
  <center><img src="res/2.%20reinstall_the_system/image-20220209142702157.png" width=400></img></center>
...
* 开始配置
  ...
  <center><img src="res/2.%20reinstall_the_system/020914194547_011111.png" width=700></img></center>
...
* 本机可以访问，其他机子无法访问，可能是`防火墙问题`或`ftp服务权限问题`
  ...
  <center><img src="res/2.reinstall_the_system/image-20220308111449946.png" width=500></img></center>

  方式二(推荐): 允许FTP服务通过防火墙

  <center><img src="res/2.reinstall_the_system/image-20220309111110966.png" width=500></img></center>
  
  关闭被动FTP
  
  <center><img src="res/2.reinstall_the_system/image-20220308111637632.png" width=400></img></center>
